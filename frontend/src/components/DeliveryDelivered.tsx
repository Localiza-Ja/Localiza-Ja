...
export default function DeliveryDelivered({
  clientName,
  street,
  neighborhoodAndCity,
  orderNumber,
      ...
      <View className="flex-row">
        <View style={{ marginRight: 20 }} className="items-center mr-4">
          <View
            style={{
              marginLeft: 20,
              backgroundColor: "rgba(53, 235, 59)",
              boxShadow: "0 0px 10px rgba(0, 235, 0, 02)",
            }}
        ...
        <View className="flex-1">
          ...
          <View className="space-y-1">
            <Text className="text-xl text-gray-800 mb-2 mr-4">
              As informações sobre a entrega serão enviadas em breve!
            </Text>
