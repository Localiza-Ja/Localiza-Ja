...
export default function DeliveryCanceled({
  clientName,
  street,
  neighborhoodAndCity,
  orderNumber,
    ...
    <View className="bg-white rounded-lg m-4 ">
      ...
      <View className="flex-row">
        <View style={{ marginRight: 20 }} className="items-center mr-4">
          <View
            style={{
              marginLeft: 20,
              backgroundColor: "red",
              boxShadow: "0 0px 10px rgba(255, 0, 0, 02)",
            }}
        ...
        <View className="flex-1">
          <View className="mb-2">
            <Text
              style={{ marginBottom: 20, fontSize: 25, color: "red" }}
          ...
          <View className="space-y-1">
            <Text className="text-xl text-gray-800 mb-2 mr-4">
              A entrega foi cancelada. Por favor, entre em contato com a empresa
